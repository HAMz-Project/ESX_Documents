...
local function OpenNewPublicFormMenu()
    ...
    for i=1, #DOCUMENT_FORMS['public'], 1 do
        elements[#elements+1] = {
            ...
            description = 'Click to create a form',
...
local function OpenMainMenu()
    lib.registerContext({
        ...
        options = {
            {
                title       = _U('public_documents'),
                description = 'Click to see a list of data',
...
RegisterNetEvent('esx_documents:client:OpenFormPropertiesMenu', function(aDocument)
    lib.registerContext({
        ...
        options = {
            ...
            {
                title       = _U('show_bt'),
                description = 'Click to show the document to nearby people',
            ...
            {
                title       = _U('delete_bt'),
                description = 'Click to delete document',
...
-- Commands
RegisterCommand('documents', function() OpenMainMenu() end)
TriggerEvent('chat:removeSuggestion', '/documents')
RegisterKeyMapping('documents', 'Open Documents', 'keyboard', Config.MenuKey)